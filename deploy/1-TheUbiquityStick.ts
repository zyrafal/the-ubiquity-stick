...
const deployTheUbiquiStick: DeployFunction = async function ({ ethers, deployments, getNamedAccounts }) {
...
export default deployTheUbiquiStick;

deployTheUbiquiStick.tags = ["TheUbiquityStick"];
